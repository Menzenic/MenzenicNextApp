...
const NavBar = () => {
  return (
    <div className="bg-slate-950 text-white w-full h-14 flex justify-between px-5">
      ...
      <Link href="/home" >
        {" "}
        <p className="cursor-pointer text-center  "><img src="Images\png\MENZENIC-NAV (1).png"/></p>{" "}
      </Link>
      </div>
     ...
     <div className="md:flex justify-between text-center font-semibold gap-2">
      ...
      <Link href={"login"}   ><p className="cursor-pointer mx-[10]">Login</p></Link>
      <Link  href="/signup" ><p className="cursor-pointer mx-[10]">SignUp</p></Link>
    </div>
